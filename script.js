...
const translations = {
  es: {
    ...
    'skills-meter-title': 'Nivel actual por tecnología',
    'skills-meter-note': 'Estimación basada en experiencia práctica en proyectos reales.',
    ...
    'cert-english-level': 'Nivel B1 · Intermediate',
  ...
  en: {
    ...
    'skills-title':   'Skills',
    'skills-meter-title': 'Current level by technology',
    'skills-meter-note': 'Estimate based on hands-on experience in real projects.',
    ...
    'cert-english-level': 'Level B1 · Intermediate',
    'contact-title':    'Contact',
    'contact-subtitle': 'Do you have an opportunity or project in mind? Let\'s talk.',
